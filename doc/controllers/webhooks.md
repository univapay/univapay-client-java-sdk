...
```java
CompletableFuture<ApiResponse<WebhookList>> listWebhooksAsync(
    final UUID storeId,
    final Integer limit,
    final UUID cursor,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`WebhookList`](../../doc/models/webhook-list.md).
...
webhooksApi.listWebhooksAsync(storeId, limit, cursor, cursorDirection, active).thenAccept(result -> {
...
```java
CompletableFuture<ApiResponse<Webhook>> createWebhookAsync(
    final UUID storeId,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`Webhook`](../../doc/models/webhook.md).

## Example Usage

```java
UUID storeId = UUID.fromString("0cab399b-5621-425b-993b-f8507eba1e78");
WebhookCreateRequest body = new WebhookCreateRequest.Builder(
    Arrays.asList(
...
webhooksApi.createWebhookAsync(storeId, body, idempotencyKey).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
CompletableFuture<ApiResponse<Webhook>> getWebhookAsync(
    final UUID storeId,
    final UUID id)
```
...
webhooksApi.getWebhookAsync(storeId, id).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
CompletableFuture<ApiResponse<Webhook>> updateWebhookAsync(
    final UUID storeId,
    final UUID id,
...
UUID storeId = UUID.fromString("0cab399b-5621-425b-993b-f8507eba1e78");
UUID id = UUID.fromString("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
WebhookUpdateRequest body = new WebhookUpdateRequest.Builder()
    .active(false)
    .build();

String idempotencyKey = "f64be872-353d-4c3c-84cb-3dc617fe89f7";

webhooksApi.updateWebhookAsync(storeId, id, body, idempotencyKey).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
CompletableFuture<ApiResponse<Void>> deleteWebhookAsync(
    final UUID storeId,
    final UUID id)
```
...
webhooksApi.deleteWebhookAsync(storeId, id).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
CompletableFuture<ApiResponse<WebhookEventList>> listWebhookEventsAsync(
    final UUID storeId,
    final UUID id,
    final Integer limit,
    final UUID cursor,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` getter of this instance returns the response data which is of type [`WebhookEventList`](../../doc/models/webhook-event-list.md).
...
webhooksApi.listWebhookEventsAsync(storeId, id, limit, cursor, cursorDirection).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
...
```java
CompletableFuture<ApiResponse<Object>> redeliverWebhookEventAsync(
    final UUID storeId,
    final UUID id,
    final UUID eventId,
    final String idempotencyKey)
...
| `storeId` | `UUID` | Template, Required | The unique identifier of the store. |
| `id` | `UUID` | Template, Required | The unique identifier of the resource. |
| `eventId` | `UUID` | Template, Required | The unique identifier of the webhook event. |
| `idempotencyKey` | `String` | Header, Optional | An optional idempotency key to prevent double charges and duplicate operations. We recommend a randomly generated UUID (v4). |
...
UUID storeId = UUID.fromString("0cab399b-5621-425b-993b-f8507eba1e78");
UUID id = UUID.fromString("c4e87129-cad4-47fb-8ded-b4c0a4ae0dd4");
UUID eventId = UUID.fromString("e1f2a3b4-c5d6-7890-efab-123456789cde");
String idempotencyKey = "f64be872-353d-4c3c-84cb-3dc617fe89f7";

webhooksApi.redeliverWebhookEventAsync(storeId, id, eventId, idempotencyKey).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    Throwable cause = exception.getCause();
