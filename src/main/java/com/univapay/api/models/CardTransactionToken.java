...
/**
 * This is a model class for CardTransactionToken type.
 */
public class CardTransactionToken {
    private UUID id;
    ...
    private TokenResponseCardData data;
     ...
     * @param  data  TokenResponseCardData value for data.
    ...
    protected CardTransactionToken(String paymentType, TokenResponseCardData data, UUID id,
     ...
     */
    @JsonCreator
    protected CardTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponseCardData data) {
     ...
     * Payment method type. Always `card` for this variant.
     * @return Returns the String
     */
     ...
     * @return Returns the TokenResponseCardData
     */
    @JsonGetter("data")
    public TokenResponseCardData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Card Data schema.
     * @param data Value for TokenResponseCardData
     */
    @JsonSetter("data")
    public void setData(TokenResponseCardData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this CardTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CardTransactionToken [" + "paymentType=" + paymentType + ", data=" + data + ", id="
    ...
    /**
     * Builds a new {@link CardTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CardTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CardTransactionToken}.
     */
    public static class Builder {
         ...
         * @param  data  TokenResponseCardData value for data.
         */
        public Builder(String paymentType, TokenResponseCardData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponseCardData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link CardTransactionToken} object using the set fields.
         * @return {@link CardTransactionToken}
         */
        public CardTransactionToken build() {
            CardTransactionToken model =
                    new CardTransactionToken(paymentType, data, id, storeId, email, active, mode,
