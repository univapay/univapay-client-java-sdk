...
/**
 * This is a model class for TransactionTokenBase type.
 */
public class TransactionTokenBase {
    private UUID id;
    ...
    protected TransactionTokenBase(UUID id, UUID storeId, OptionalNullable<String> email,
            Boolean active, TransactionTokenMode mode, TransactionTokenType type,
    ...
    /**
     * Converts this TransactionTokenBase into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TransactionTokenBase [" + "id=" + id + ", storeId=" + storeId + ", email=" + email
                + ", active=" + active + ", mode=" + mode + ", type=" + type + ", usageLimit="
                + usageLimit + ", confirmed=" + confirmed + ", metadata=" + metadata
                + ", createdOn=" + createdOn + ", updatedOn=" + updatedOn + ", lastUsedOn="
                + lastUsedOn + ", additionalProperties=" + additionalProperties + "]";
    }

    /**
     * Builds a new {@link TransactionTokenBase.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TransactionTokenBase.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TransactionTokenBase}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TransactionTokenBase} object using the set fields.
         * @return {@link TransactionTokenBase}
         */
        public TransactionTokenBase build() {
            TransactionTokenBase model =
                    new TransactionTokenBase(id, storeId, email, active, mode, type, usageLimit,
                            confirmed, metadata, createdOn, updatedOn, lastUsedOn);
