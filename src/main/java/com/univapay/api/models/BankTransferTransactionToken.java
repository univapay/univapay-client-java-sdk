...
/**
 * This is a model class for BankTransferTransactionToken type.
 */
public class BankTransferTransactionToken {
    private UUID id;
    ...
    private TokenResponseBankTransferData data;
     ...
     * Default constructor.
     */
    public BankTransferTransactionToken() {
     ...
     * @param  data  TokenResponseBankTransferData value for data.
    ...
    public BankTransferTransactionToken(
            String paymentType,
            TokenResponseBankTransferData data,
            UUID id,
            UUID storeId,
            String email,
            Boolean active,
    ...
    protected BankTransferTransactionToken(String paymentType, TokenResponseBankTransferData data,
            UUID id, UUID storeId, OptionalNullable<String> email, Boolean active,
            TransactionTokenMode mode, TransactionTokenType type,
            OptionalNullable<String> usageLimit, OptionalNullable<Boolean> confirmed,
            Map<String, TransactionTokenMetadataAdditionalProperties> metadata,
     ...
     */
    @JsonCreator
    protected BankTransferTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponseBankTransferData data) {
     ...
     * Payment method type. Always `bank_transfer` for this variant.
     * @return Returns the String
     */
     ...
     * @return Returns the TokenResponseBankTransferData
     */
    @JsonGetter("data")
    public TokenResponseBankTransferData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Bank Transfer Data schema.
     * @param data Value for TokenResponseBankTransferData
     */
    @JsonSetter("data")
    public void setData(TokenResponseBankTransferData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this BankTransferTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BankTransferTransactionToken [" + "paymentType=" + paymentType + ", data=" + data
    ...
    /**
     * Builds a new {@link BankTransferTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BankTransferTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BankTransferTransactionToken}.
     */
    public static class Builder {
         ...
         * @param  data  TokenResponseBankTransferData value for data.
         */
        public Builder(String paymentType, TokenResponseBankTransferData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponseBankTransferData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link BankTransferTransactionToken} object using the set fields.
         * @return {@link BankTransferTransactionToken}
         */
        public BankTransferTransactionToken build() {
            BankTransferTransactionToken model =
                    new BankTransferTransactionToken(paymentType, data, id, storeId, email, active,
                            mode, type, usageLimit, confirmed, metadata, createdOn, updatedOn,
                            lastUsedOn);
