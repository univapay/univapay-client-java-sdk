...
/**
 * This is a model class for TokenCreateOnlineData type.
 */
public class TokenCreateOnlineData {
    ...
    protected TokenCreateOnlineData(BaseOnlineDataBrand brand, BaseOnlineDataCallMethod callMethod,
     ...
     */
    @JsonCreator
    protected TokenCreateOnlineData(
            @JsonProperty("brand") BaseOnlineDataBrand brand,
            @JsonProperty("call_method") BaseOnlineDataCallMethod callMethod) {
        this(brand, callMethod, OptionalNullable.of(null), OptionalNullable.of(null),
                OptionalNullable.of(null));
        unsetOsType();
        unsetUserIdentifier();
        unsetUserIdentifierSource();
    }
    ...
    /**
     * Converts this TokenCreateOnlineData into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TokenCreateOnlineData [" + "brand=" + brand + ", callMethod=" + callMethod
                + ", osType=" + osType + ", userIdentifier=" + userIdentifier
                + ", userIdentifierSource=" + userIdentifierSource + ", additionalProperties="
                + additionalProperties + "]";
    }

    /**
     * Builds a new {@link TokenCreateOnlineData.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TokenCreateOnlineData.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(brand, callMethod);
    ...
    /**
     * Class to build instances of {@link TokenCreateOnlineData}.
     */
    public static class Builder {
         ...
         * @param  callMethod  BaseOnlineDataCallMethod value for callMethod.
         */
        public Builder(BaseOnlineDataBrand brand, BaseOnlineDataCallMethod callMethod) {
            this.brand = brand;
            this.callMethod = callMethod;
        }
        ...
        /**
         * Builds a new {@link TokenCreateOnlineData} object using the set fields.
         * @return {@link TokenCreateOnlineData}
         */
        public TokenCreateOnlineData build() {
            TokenCreateOnlineData model =
                    new TokenCreateOnlineData(brand, callMethod, osType, userIdentifier,
                            userIdentifierSource);
