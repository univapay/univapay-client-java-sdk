...
/**
 * This is a model class for PaidyTransactionToken type.
 */
public class PaidyTransactionToken {
    private UUID id;
    ...
    private TokenResponsePaidyData data;
     ...
     * @param  data  TokenResponsePaidyData value for data.
    ...
    protected PaidyTransactionToken(String paymentType, TokenResponsePaidyData data, UUID id,
     ...
     */
    @JsonCreator
    protected PaidyTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponsePaidyData data) {
     ...
     * @return Returns the TokenResponsePaidyData
     */
    @JsonGetter("data")
    public TokenResponsePaidyData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Paidy Data schema.
     * @param data Value for TokenResponsePaidyData
     */
    @JsonSetter("data")
    public void setData(TokenResponsePaidyData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this PaidyTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaidyTransactionToken [" + "paymentType=" + paymentType + ", data=" + data + ", id="
                + id + ", storeId=" + storeId + ", email=" + email + ", active=" + active
    ...
    /**
     * Builds a new {@link PaidyTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaidyTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaidyTransactionToken}.
     */
    public static class Builder {
        private String paymentType = "paidy";
        private TokenResponsePaidyData data;
        private UUID id;
        private UUID storeId;
        private OptionalNullable<String> email;
         ...
         * @param  data  TokenResponsePaidyData value for data.
         */
        public Builder(String paymentType, TokenResponsePaidyData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponsePaidyData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link PaidyTransactionToken} object using the set fields.
         * @return {@link PaidyTransactionToken}
         */
        public PaidyTransactionToken build() {
            PaidyTransactionToken model =
                    new PaidyTransactionToken(paymentType, data, id, storeId, email, active, mode,
