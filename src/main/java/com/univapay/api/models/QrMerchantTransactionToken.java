...
/**
 * This is a model class for QrMerchantTransactionToken type.
 */
public class QrMerchantTransactionToken {
    private UUID id;
    ...
    private TokenResponseQrMerchantData data;
     ...
     * Default constructor.
     */
    public QrMerchantTransactionToken() {
     ...
     * @param  data  TokenResponseQrMerchantData value for data.
    ...
    public QrMerchantTransactionToken(
            String paymentType,
            TokenResponseQrMerchantData data,
            UUID id,
            UUID storeId,
            String email,
            Boolean active,
    ...
    protected QrMerchantTransactionToken(String paymentType, TokenResponseQrMerchantData data,
     ...
     */
    @JsonCreator
    protected QrMerchantTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponseQrMerchantData data) {
     ...
     * @return Returns the TokenResponseQrMerchantData
     */
    @JsonGetter("data")
    public TokenResponseQrMerchantData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Qr Merchant Data schema.
     * @param data Value for TokenResponseQrMerchantData
     */
    @JsonSetter("data")
    public void setData(TokenResponseQrMerchantData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this QrMerchantTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "QrMerchantTransactionToken [" + "paymentType=" + paymentType + ", data=" + data
    ...
    /**
     * Builds a new {@link QrMerchantTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link QrMerchantTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link QrMerchantTransactionToken}.
     */
    public static class Builder {
        private String paymentType = "qr_merchant";
        private TokenResponseQrMerchantData data;
        private UUID id;
        private UUID storeId;
        private OptionalNullable<String> email;
         ...
         * @param  data  TokenResponseQrMerchantData value for data.
         */
        public Builder(String paymentType, TokenResponseQrMerchantData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponseQrMerchantData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link QrMerchantTransactionToken} object using the set fields.
         * @return {@link QrMerchantTransactionToken}
         */
        public QrMerchantTransactionToken build() {
            QrMerchantTransactionToken model =
                    new QrMerchantTransactionToken(paymentType, data, id, storeId, email, active,
