...
/**
 * This is a model class for OnlineTransactionToken type.
 */
public class OnlineTransactionToken {
    private UUID id;
    ...
    private TokenResponseOnlineData data;
     ...
     * @param  data  TokenResponseOnlineData value for data.
    ...
    protected OnlineTransactionToken(String paymentType, TokenResponseOnlineData data, UUID id,
     ...
     */
    @JsonCreator
    protected OnlineTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponseOnlineData data) {
     ...
     * @return Returns the TokenResponseOnlineData
     */
    @JsonGetter("data")
    public TokenResponseOnlineData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Online Data schema.
     * @param data Value for TokenResponseOnlineData
     */
    @JsonSetter("data")
    public void setData(TokenResponseOnlineData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this OnlineTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OnlineTransactionToken [" + "paymentType=" + paymentType + ", data=" + data
    ...
    /**
     * Builds a new {@link OnlineTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OnlineTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link OnlineTransactionToken}.
     */
    public static class Builder {
         ...
         * @param  data  TokenResponseOnlineData value for data.
         */
        public Builder(String paymentType, TokenResponseOnlineData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponseOnlineData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link OnlineTransactionToken} object using the set fields.
         * @return {@link OnlineTransactionToken}
         */
        public OnlineTransactionToken build() {
            OnlineTransactionToken model =
                    new OnlineTransactionToken(paymentType, data, id, storeId, email, active, mode,
