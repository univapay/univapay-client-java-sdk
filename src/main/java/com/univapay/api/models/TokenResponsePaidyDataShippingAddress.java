...
/**
 * This is a model class for TokenResponsePaidyDataShippingAddress type.
 */
public class TokenResponsePaidyDataShippingAddress {
    ...
    protected TokenResponsePaidyDataShippingAddress(OptionalNullable<String> zip,
            OptionalNullable<String> line1, OptionalNullable<String> line2,
    ...
    /**
     * Converts this TokenResponsePaidyDataShippingAddress into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TokenResponsePaidyDataShippingAddress [" + "zip=" + zip + ", line1=" + line1
                + ", line2=" + line2 + ", city=" + city + ", state=" + state
                + ", additionalProperties=" + additionalProperties + "]";
    }

    /**
     * Builds a new {@link TokenResponsePaidyDataShippingAddress.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TokenResponsePaidyDataShippingAddress.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TokenResponsePaidyDataShippingAddress}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TokenResponsePaidyDataShippingAddress} object using the set fields.
         * @return {@link TokenResponsePaidyDataShippingAddress}
         */
        public TokenResponsePaidyDataShippingAddress build() {
            TokenResponsePaidyDataShippingAddress model =
                    new TokenResponsePaidyDataShippingAddress(zip, line1, line2, city, state);
