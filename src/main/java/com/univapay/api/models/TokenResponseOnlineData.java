...
/**
 * This is a model class for TokenResponseOnlineData type.
 */
public class TokenResponseOnlineData {
    ...
    private OptionalNullable<String> issuerTokenPayload;
     ...
     * Default constructor.
     */
    public TokenResponseOnlineData() {
    }
     ...
     * @param  issuerTokenPayload  String value for issuerTokenPayload.
     */
    public TokenResponseOnlineData(
        ...
        this.issuerTokenPayload = OptionalNullable.of(issuerTokenPayload);
    }
    ...
    protected TokenResponseOnlineData(BaseOnlineDataBrand brand,
            BaseOnlineDataCallMethod callMethod, OptionalNullable<BaseOnlineDataOsType> osType,
            OptionalNullable<String> userIdentifier,
            OptionalNullable<BaseOnlineDataUserIdentifierSource> userIdentifierSource,
            OptionalNullable<String> issuerToken, OptionalNullable<String> issuerTokenPayload) {
        this.brand = brand;
        this.callMethod = callMethod;
        this.osType = osType;
        ...
        this.issuerTokenPayload = issuerTokenPayload;
    }
    ...
    /**
     * Internal Getter for IssuerTokenPayload.
     * Additional payload from the issuer.
     * @return Returns the Internal String
     */
    @JsonGetter("issuer_token_payload")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<String> internalGetIssuerTokenPayload() {
        return this.issuerTokenPayload;
    }

    /**
     * Getter for IssuerTokenPayload.
     * Additional payload from the issuer.
     * @return Returns the String
     */
    public String getIssuerTokenPayload() {
        return OptionalNullable.getFrom(issuerTokenPayload);
    }

    /**
     * Setter for IssuerTokenPayload.
     * Additional payload from the issuer.
     * @param issuerTokenPayload Value for String
     */
    @JsonSetter("issuer_token_payload")
    public void setIssuerTokenPayload(String issuerTokenPayload) {
        this.issuerTokenPayload = OptionalNullable.of(issuerTokenPayload);
    }

    /**
     * UnSetter for IssuerTokenPayload.
     * Additional payload from the issuer.
     */
    public void unsetIssuerTokenPayload() {
        issuerTokenPayload = null;
    }
    ...
    /**
     * Converts this TokenResponseOnlineData into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TokenResponseOnlineData [" + "brand=" + brand + ", callMethod=" + callMethod
                + ", osType=" + osType + ", userIdentifier=" + userIdentifier
                + ", userIdentifierSource=" + userIdentifierSource + ", issuerToken=" + issuerToken
                + ", issuerTokenPayload=" + issuerTokenPayload + ", additionalProperties="
                + additionalProperties + "]";
    }

    /**
     * Builds a new {@link TokenResponseOnlineData.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TokenResponseOnlineData.Builder} object
     */
    public Builder toBuilder() {
        ...
        builder.issuerTokenPayload = internalGetIssuerTokenPayload();
        builder.additionalProperties = additionalProperties;
        return builder;
    }

    /**
     * Class to build instances of {@link TokenResponseOnlineData}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder issuerTokenPayload(String issuerTokenPayload) {
            this.issuerTokenPayload = OptionalNullable.of(issuerTokenPayload);
            return this;
        }
         ...
         * @return Builder
         */
        public Builder unsetIssuerTokenPayload() {
            issuerTokenPayload = null;
            return this;
        }
        ...
        /**
         * Builds a new {@link TokenResponseOnlineData} object using the set fields.
         * @return {@link TokenResponseOnlineData}
         */
        public TokenResponseOnlineData build() {
            TokenResponseOnlineData model =
                    new TokenResponseOnlineData(brand, callMethod, osType, userIdentifier,
                            userIdentifierSource, issuerToken, issuerTokenPayload);
