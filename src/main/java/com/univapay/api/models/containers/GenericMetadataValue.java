 ...
 */
@JsonDeserialize(using = GenericMetadataValue.GenericMetadataValueDeserializer.class)
public abstract class GenericMetadataValue {
     ...
     */
    public static GenericMetadataValue fromString(String string) {
     ...
     */
    public static GenericMetadataValue fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends GenericMetadataValue {
    ...
    private static class PrecisionCase extends GenericMetadataValue {
    ...
    private static class BooleanCase extends GenericMetadataValue {
    ...
    protected static class GenericMetadataValueDeserializer
            extends JsonDeserializer<GenericMetadataValue> {

        @Override
        public GenericMetadataValue deserialize(JsonParser jp, DeserializationContext ctxt)
