 ...
 */
@JsonDeserialize(using = TransactionTokenMetadataAdditionalProperties.TransactionTokenMetadataAdditionalPropertiesDeserializer.class)
public abstract class TransactionTokenMetadataAdditionalProperties {
     ...
     */
    public static TransactionTokenMetadataAdditionalProperties fromString(String string) {
     ...
     */
    public static TransactionTokenMetadataAdditionalProperties fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends TransactionTokenMetadataAdditionalProperties {
    ...
    private static class PrecisionCase extends TransactionTokenMetadataAdditionalProperties {
    ...
    private static class BooleanCase extends TransactionTokenMetadataAdditionalProperties {
    ...
    /**
     * This is a custom deserializer class for TransactionTokenMetadataAdditionalProperties.
     */
    protected static class TransactionTokenMetadataAdditionalPropertiesDeserializer
            extends JsonDeserializer<TransactionTokenMetadataAdditionalProperties> {

        @Override
        public TransactionTokenMetadataAdditionalProperties deserialize(JsonParser jp, DeserializationContext ctxt)
