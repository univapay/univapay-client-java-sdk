...
/**
 * This is a model class for CustomsDeclarationWebhookDeclaration type.
 */
public class CustomsDeclarationWebhookDeclaration {
     ...
     * Default constructor.
     */
    public CustomsDeclarationWebhookDeclaration() {
    }
    ...
    /**
     * Converts this CustomsDeclarationWebhookDeclaration into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CustomsDeclarationWebhookDeclaration [" + "customs=" + customs
                + ", merchantCustomsNo=" + merchantCustomsNo + ", certificateId=" + certificateId
                + ", certificateName=" + certificateName + ", additionalProperties="
                + additionalProperties + "]";
    }

    /**
     * Builds a new {@link CustomsDeclarationWebhookDeclaration.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CustomsDeclarationWebhookDeclaration.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder()
                .customs(getCustoms())
                .merchantCustomsNo(getMerchantCustomsNo())
    ...
    /**
     * Class to build instances of {@link CustomsDeclarationWebhookDeclaration}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CustomsDeclarationWebhookDeclaration} object using the set fields.
         * @return {@link CustomsDeclarationWebhookDeclaration}
         */
        public CustomsDeclarationWebhookDeclaration build() {
            CustomsDeclarationWebhookDeclaration model =
                    new CustomsDeclarationWebhookDeclaration(customs, merchantCustomsNo,
