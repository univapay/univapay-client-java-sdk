...
/**
 * This is a model class for QrScanTransactionToken type.
 */
public class QrScanTransactionToken {
    ...
    private TokenResponseQrScanData data;
     ...
     * @param  data  TokenResponseQrScanData value for data.
    ...
    protected QrScanTransactionToken(String paymentType, TokenResponseQrScanData data, UUID id,
     ...
     */
    @JsonCreator
    protected QrScanTransactionToken(
            @JsonProperty("payment_type") String paymentType,
            @JsonProperty("data") TokenResponseQrScanData data) {
     ...
     * @return Returns the TokenResponseQrScanData
     */
    @JsonGetter("data")
    public TokenResponseQrScanData getData() {
        return data;
    }
     ...
     * Setter for Data.
     * Token Response Qr Scan Data schema.
     * @param data Value for TokenResponseQrScanData
     */
    @JsonSetter("data")
    public void setData(TokenResponseQrScanData data) {
        this.data = data;
    }
    ...
    /**
     * Converts this QrScanTransactionToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "QrScanTransactionToken [" + "paymentType=" + paymentType + ", data=" + data
    ...
    /**
     * Builds a new {@link QrScanTransactionToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link QrScanTransactionToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link QrScanTransactionToken}.
     */
    public static class Builder {
        private String paymentType = "qr_scan";
        private TokenResponseQrScanData data;
        private UUID id;
        private UUID storeId;
        private OptionalNullable<String> email;
         ...
         * @param  data  TokenResponseQrScanData value for data.
         */
        public Builder(String paymentType, TokenResponseQrScanData data) {
            this.paymentType = paymentType;
            this.data = data;
        }
         ...
         * @return Builder
         */
        public Builder data(TokenResponseQrScanData data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link QrScanTransactionToken} object using the set fields.
         * @return {@link QrScanTransactionToken}
         */
        public QrScanTransactionToken build() {
            QrScanTransactionToken model =
                    new QrScanTransactionToken(paymentType, data, id, storeId, email, active, mode,
