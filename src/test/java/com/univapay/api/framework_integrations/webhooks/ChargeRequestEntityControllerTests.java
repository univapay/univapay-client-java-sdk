...
import com.univapay.api.framework_integrations.webhooks.apps.ChargeRequestEntityController;
...
public class ChargeRequestEntityControllerTests {

    private static MockMvc mockMvc;

    @BeforeClass
    public static void setUpClass() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(new ChargeRequestEntityController()).build();
    }
    ...
    public void onChargeUpdated_ReturnsChargeUpdatedEvent() throws Exception {
        ...
        // Act
        mockMvc.perform(post("/charge-request-entity")
